...
describe("isValidRule", () => {
  ...
  it("validates a field when the filter field parameter accepts its values", () => {
    ...
    expect(
      isValidRule({
        filterFnList: [strictStringFilter],
        dataSchema: optionalSchema,
    ...
    expect(
      isValidRule({
        filterFnList: [nullishStringFilter],
        dataSchema: optionalSchema,
        rule: createSingleFilter({
          name: "Nullish string",
          path: ["name"],
    ...
    expect(
      isValidRule({
        filterFnList: [strictStringFilter],
        dataSchema: z.object({ value: z.any() }),
        rule: createSingleFilter({
          name: "Strict string",
          path: ["value"],
          args: ["Alice"],
