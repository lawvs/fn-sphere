...
Field descriptions are Zod schema metadata. See [Schema Metadata](/fn-sphere/customization/schema-metadata/) to learn how to define typed metadata keys and read them in custom consumers.
