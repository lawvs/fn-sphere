...
import { PresetCollection } from "~/components/examples/preset-collection.tsx";

<div className="not-content">
  <PresetCollection client:only />
</div>

<SourceCodeCard path="~/components/examples/preset-collection.tsx" />
